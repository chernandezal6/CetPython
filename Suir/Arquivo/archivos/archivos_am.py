...
def validar_detalle(linea, stack_msg):
	...
	v_msg="Error en la linea %s la longitud es incorrecta, este tipo de archivo debe ser de (292,308,312) posiciones" % (iLineas)
...
def cargar_movimiento(id_envio, oCurs, stack_msg, exception_msg):
	v_result = "0"
	try:		
		oCurs.callproc("SRE_PROCESAR_PYTHON_PKG.procesar_am_ar",[id_envio,v_result])
