...
class pruebas_archivos_da(unittest2.TestCase):
	def test_validar_encabezado(self):
		global stack_msg
		self.assertEqual(archivos_da.validar_encabezado("EDA  3456789121234567893214567", stack_msg), True)
	...
	def test_validar_encabezado_rnc_o_cedula(self):
		self.assertEqual(archivos_da.validar_encabezado("EDA  34567a9121234567893214567", []), False)
	...
	def test_validar_detalle(self):
		global stack_msg
		self.assertEqual(archivos_da.validar_detalle("D1234567891234567              011817920920000000000123.000000000000123.00P001", stack_msg), True)
		self.assertEqual(archivos_da.validar_detalle("D1234567891234567              0118179209200000000000000000000000000000000T001", stack_msg), True)
	...
	def test_validar_detalle_nro_documento(self):
		self.assertEqual(archivos_da.validar_detalle("D2012123456789123              00118A792090000000000000.000000000000000.00T001", []), False)
	...
	def test_validar_detalle_salario(self):
		...
		self.assertEqual(archivos_da.validar_detalle("D201212345678912300000000000000001181792090000000000500.000000000000000.00T001", []), False)
	...
	def test_validar_detalle_aportes_voluntario(self):
		...
		self.assertEqual(archivos_da.validar_detalle("D201212345678912300000000000000001181792090000000000000.000000000000500.00T001", []), False)
