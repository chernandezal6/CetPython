...
namespace AsignacionNSSMenorExt
{
    public class AsignacionNSSMenorEXT
    {
        public static void Main()
        {
            ...
            {
                channel.QueueDeclare(queue: "asignacion_nss_menor_extranjero",
                                     durable: true,
                                     exclusive: false,
                                     autoDelete: false,
                                     arguments: null);
                ...
                consumer.Received += (model, ea) =>
                {
                    ...
                    Console.WriteLine("Solicitud: {0} asignacion_nss_menor_extranjero", message);
                ...
                channel.BasicConsume(queue: "asignacion_nss_menor_extranjero",
                                     noAck: false,
                                     consumer: consumer);

                Console.WriteLine(" Press [enter] to exit asignacion_nss_menor_extranjero.");
                Console.ReadLine();
            }
        }
