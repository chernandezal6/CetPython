...
namespace AsignacionNSSMenorActa
{
    public class AsignacionNSSMenorActa
    {
        ...
        {            
            ...
            {
                channel.QueueDeclare(queue: "asignacion_nss_menor_nac_acta",
                                     durable: true,
                                     exclusive: false,
                                     autoDelete: false,
                                     arguments: null);
                ...
                consumer.Received += (model, ea) =>
                {
                    ...
                    Console.WriteLine("Solicitud: {0} asignacion_nss_menor_nac_acta", message);
                ...
                channel.BasicConsume(queue: "asignacion_nss_menor_nac_acta",
                                     noAck: false,
                                     consumer: consumer);

                Console.WriteLine(" Press [enter] to exit asignacion_nss_menor_nac_acta.");
                Console.ReadLine();
            }
        }
