...
namespace AsignacionNSSCedulado
{
    public class AsignacionNSSCedulado
    {
        public static void Main()
        {
            ...
            {
                channel.QueueDeclare(queue: "asignacion_nss_cedulado",
                                     durable: true,
                                     exclusive: false,
                                     autoDelete: false,
                                     arguments: null);
                ...
                consumer.Received += (model, ea) =>
                {
                    ...
                    Console.WriteLine("Solicitud: {0} asignacion_nss_cedulado", message);
                ...
                channel.BasicConsume(queue: "asignacion_nss_cedulado",
                                     noAck: false,
                                     consumer: consumer);

                Console.WriteLine(" Press [enter] to exit asignacion_nss_cedulado.");
                Console.ReadLine();
            }
        }
