...
{
    [Migration(201711011103)]
    public class _201711011103_create_package_sub_sfs_novedades_pkg : FluentMigrator.Migration
    {
                          ...
                          BEGIN
                            ...
                            Select count(*)
                             ...
                             Where owner       = 'SUIRPLUS'
                               And object_name = 'SUB_SFS_NOVEDADES'
                               And object_type = 'PACKAGE';

                            --Si el objeto exite, lo borramos
                            If v_conteo > 0 Then
                              EXECUTE IMMEDIATE('DROP PACKAGE SUIRPLUS.SUB_SFS_NOVEDADES');
                            End if;                          
                          END;");
        }
    }
