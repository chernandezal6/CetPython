...
{
    public class ManejoArchivoPython
    {
        ...
        public ManejoArchivoPython(int id_referencia, string rnc)
        {
        ...
        //Para los tipos de archivos diferentes a "pensionados"
        public ManejoArchivoPython(string FileName, Stream data, SuirArchivoType tipoArchivo, string username, int nss, string rncEmpleador, string id_entidad_rec,string IPAddress)
        {
            if (FileName != null)
            {
                ...
                //verificamos que el archivo fisico no comiense con saltos de lineas.
                if (!esArchivoValido(myArchivoStream))
                {                    
                    myCodigoError = 86;
                    myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                    throw new Exception(myMensajeError);
                ...
                if (tipoArchivo == SuirArchivoType.FacturaAuditoria)
                {
                    ...
                    {
                        string myRNC = getRNC(myArchivoStream);
                        if ((Utils.esValorNumerico(myRNC) == false) || ((myRNC.Length != 9) && (myRNC.Length != 11)))
                        {
                            myCodigoError = 150;
                            myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                            throw new Exception(myMensajeError);
                    ...
                    this.username = username;                    
                    this.GuardarArchivo(myArchivoStream, tipoArchivo, rncEmpleador,null, IPAddress);
                ...
                if ((tipoArchivo == SuirArchivoType.Aclaracion) || (tipoArchivo == SuirArchivoType.Recaudacion))
                {
                    ...
                    //Verificamos que el nombre del archivo comiense con "DGII-" / "INFOTEP-"
                    if (!esNombreValido())
                    {
                        myCodigoError = 208;
                        myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                   ...
                   // GuardarArchivo(this.readerFile, tipoArchivo, rncEmpleador,IPAddress);
                    GuardarArchivo(myArchivoStream, tipoArchivo, rncEmpleador, id_entidad_rec, IPAddress);
                }
                    ...
                    )
                {
                    ...
                    if (!(tipoArchivo == SuirArchivoType.TraspasoPensionados))
                    {
                        ...
                        if ((Utils.esValorNumerico(rnc) == false) || ((rnc.Length != 9) && (rnc.Length != 11)))
                        {
                            myCodigoError = 150;
                            myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                            throw new Exception(myMensajeError);
                    ...
                    else
                    {
                        ...
                        //validar periodo enviado
                        validarPeriodo(periodo, tipoArchivo);
                    }
                    ...
                    switch (tipoArchivo)
                    {
                        ...
                        case SuirArchivoType.Bonificacion:
                            ...
                            ///pendiente validar periodos futuros en los bo
                    ...
                    GuardarArchivo(myArchivoStream, tipoArchivo, rncEmpleador, null, IPAddress);

                }

                //Validacion de regimen subsidiado no requiere pre-validaciones
                if (tipoArchivo == ManejoArchivoPython.SuirArchivoType.ValidacionRegimenSubsidiado)
                {
                    string periodo = string.Empty;
                    ...
                    periodo = this.getPeriodoVS(myArchivoStream);
                    //reordenamos el periodo para igualarlo a los demas archivos
        ...
        public ManejoArchivoPython(HttpPostedFile archivo, SuirArchivoType tipoArchivo, string username, int nss, string rncEmpleador, string IPAddress)
        {
            ...
            if (archivo != null)
            {
                ...
                if ((tipoArchivo == SuirArchivoType.Aclaracion) || (tipoArchivo == SuirArchivoType.Recaudacion))
                {
                    ...
                    //Guardamos el archivo de los bancos.
                    //this.GuardarArchivo(this.readerFile, tipoArchivo, rncEmpleador,IPAddress);
                    GuardarArchivo(myArchivoStream, tipoArchivo, rncEmpleador, null, IPAddress);
        ...
        //para archivos pensionados
        public ManejoArchivoPython(string FileName, Stream data, SuirArchivoType tipoArchivo, string username, string idars, string IPAddress)
        {
            if (FileName != null)
            {
                //Asignamos los valores las propiedades.
                ...
                //Guardamos el archivo					
                GuardarArchivo(myArchivoStream, tipoArchivo, rncEmpleador,idars, IPAddress);
        ...
        /// <summary>
        /// Funcion utilizada para validar la estructura del archivo enviado
        /// </summary>

        public bool esArchivoValido(Stream archivo)
        {
            archivo.Position = 0;
            string primeraLinea = string.Empty;
            StreamReader rLectorArchivo3 = new StreamReader(archivo, Encoding.UTF8);
            primeraLinea = rLectorArchivo3.ReadLine();
            archivo.Position = 0;
            try
            {
                if ((primeraLinea.Trim().Length >= 3)) 
                {
                    return true;
                }
                else
        ...
        public bool esValidoParaElProceso(Stream archivo, SuirArchivoType tipoArchivo)
        {
            ...
            switch (tipoArchivo)
            {
                ...
                case SuirArchivoType.AutodeterminacionMensual:
                    ...
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("AM"))) archivoValido = true;
                    }
                ...
                case SuirArchivoType.AutodeterminacionRetroactiva:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("AR"))) archivoValido = true;
                ...
                case SuirArchivoType.FacturaAuditoria:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("RA"))) archivoValido = true;
                ...
                case SuirArchivoType.CreditoFacturaAuditoria:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("RC"))) archivoValido = true;
                ...
                case SuirArchivoType.PagoRetroactivoEnfermedadNoLaboral:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("PR"))) archivoValido = true;
                ...
                case SuirArchivoType.NovedadesAtrasadas:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("NA"))) archivoValido = true;
                ...
                case SuirArchivoType.NovedadesPeriodo:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == "E") && (linea.Substring(1, 2) == "NV")) archivoValido = true;
                ...
                case SuirArchivoType.DependientesAdicionales:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("RD"))) archivoValido = true;
                ...
                case SuirArchivoType.DeclaracionFinalIR3:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("DF"))) archivoValido = true;
                    }
                ...
                case SuirArchivoType.Rectificativa:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("RT"))) archivoValido = true;
                    }
                ...
                case SuirArchivoType.Bonificacion:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("BO"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.DevolucionAportes:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("DA"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.NovedadesPensionados:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("PN"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.TraspasoPensionados:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("PT"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.ValidacionRegimenSubsidiado:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("VS"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.PlanillaDGT3:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("T3"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.PlanillaDGT4:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("T4"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.EstatusDefinitivoAuditoria:
                    {
                        ...
                        if (linea != string.Empty || linea != null)
                        {
                            if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("EA"))) archivoValido = true;
                        }
                ...
                case SuirArchivoType.MovimientoTrabajadores:
                    ...
                    if (linea != string.Empty || linea != null)
                    {
                        if ((linea.Substring(0, 1) == ("E")) && (linea.Substring(1, 2) == ("MO"))) archivoValido = true;
                    }
        ...
        /// </summary>
        /// <param name="archivo">el archivo que posteo el empleador</param>
        /// <returns>una cadena representando el periodo en formato añomes ej: "200601"</returns>
        public string getPeriodoVS(Stream archivo)
        {
            archivo.Position = 0;
            string periodo = string.Empty;
            StreamReader rLectorArchivo3 = new StreamReader(archivo, Encoding.UTF8);
        ...
        /// <summary>
        /// Funcion utilizada para validar el periodo enviado en el archivo
        /// </summary>
        public string validarPeriodo(string periodoEnviado, SuirArchivoType tipoArchivo)
        {           
            try
            {
                string periodoActual = TSS.getPeriodoVigente(null);

                if ((periodoEnviado.Contains("\0"))||(Utils.esValorNumerico(periodoEnviado) == false) || (periodoEnviado.Length != 6))
                {                    
                    myCodigoError = 83;
                    myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                    throw new Exception(myMensajeError);
                }
                if (Convert.ToInt32(periodoEnviado.Substring(2, 4)) < 2003)
                {
                    myCodigoError = 83;
                    myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                    throw new Exception(myMensajeError);
                }
                if ((Convert.ToInt32(periodoEnviado.Substring(0, 2)) > 12) || (Convert.ToInt32(periodoEnviado.Substring(0, 2)) < 1))
                {
                    myCodigoError = 85;
                    myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                    throw new Exception(myMensajeError);
                ...
                string periodoEnviado_f = "01/" + periodoEnviado.Substring(0, 2) + "/" + periodoEnviado.Substring(2, 4);
                string periodoActual_f = "01/" + periodoActual.Substring(0, 2) + "/" + periodoActual.Substring(2, 4);
                DateTime fechaperiodoEnviado = Utils.FormatearFecha(periodoEnviado_f);
                DateTime fechaPeriodoActual = Utils.FormatearFecha(periodoActual_f);

                if (fechaperiodoEnviado < Convert.ToDateTime("01/06/2003"))
                {
                    myCodigoError = 83;
                    myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                    throw new Exception(myMensajeError);
                ...
                if (fechaperiodoEnviado > fechaPeriodoActual)
                {
                    myCodigoError = 84;
                    myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                    throw new Exception(myMensajeError);
                ...
                if ((tipoArchivo == SuirArchivoType.AutodeterminacionMensual) || (tipoArchivo == SuirArchivoType.NovedadesPeriodo) || (tipoArchivo == SuirArchivoType.MovimientoTrabajadores))
                {
                    if (periodoEnviado_f != periodoActual_f)
                    {
                        myCodigoError = 83;
                        myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                        throw new Exception(myMensajeError);
                ...
                if (tipoArchivo == SuirArchivoType.AutodeterminacionRetroactiva)
                {
                    if (periodoEnviado_f == periodoActual_f)
                    {
                        myCodigoError = 83;
                ...
                if (tipoArchivo == SuirArchivoType.Bonificacion)
                {
                    if (TSS.getPeriodoBonificacionValido(periodoEnviado) == "FALSE")
                    {
                        myCodigoError = 83;
                        myMensajeError = Utilitarios.TSS.getErrorDescripcion(myCodigoError);
                        throw new Exception(myMensajeError);
        ...
        public void GuardarArchivo(Stream archivo, SuirArchivoType tipoArchivo, string rnc_cedula, string id_Entidad, string IPAddress)
        {
            ...
            { arrParam[1].Value = "PN"; myTipoProceso = "PN";}
            else if (tipoArchivo == SuirArchivoType.TraspasoPensionados)
            { arrParam[1].Value = "PT"; myTipoProceso = "PT"; }
            else if (tipoArchivo == SuirArchivoType.ValidacionRegimenSubsidiado)
            { arrParam[1].Value = "VS"; myTipoProceso = "VS"; }
            else if (tipoArchivo == SuirArchivoType.AutodeterminacionMensual)
            { arrParam[1].Value = "AM"; myTipoProceso ="AM";}
            else if (tipoArchivo == SuirArchivoType.AutodeterminacionRetroactiva)
            { arrParam[1].Value = "AR"; myTipoProceso ="AR";}
            else if (tipoArchivo == SuirArchivoType.NovedadesPeriodo)
            { arrParam[1].Value = "NV"; myTipoProceso ="NV"; }
            else if (tipoArchivo == SuirArchivoType.NovedadesAtrasadas)
            { arrParam[1].Value = "NA"; myTipoProceso ="NA";}
            else if (tipoArchivo == SuirArchivoType.FacturaAuditoria)
            { arrParam[1].Value = "RA"; myTipoProceso ="RA";}
            else if (tipoArchivo == SuirArchivoType.CreditoFacturaAuditoria)
            { arrParam[1].Value = "RC"; myTipoProceso ="RC";}
            else if (tipoArchivo == SuirArchivoType.Recaudacion)
            { arrParam[1].Value = "EP"; myTipoProceso ="EP";}
            else if (tipoArchivo == SuirArchivoType.Aclaracion)
            { arrParam[1].Value = "AC"; myTipoProceso ="AC"; }
            else if (tipoArchivo == SuirArchivoType.CancelacionesAutorizaciones)
            { arrParam[1].Value = "CAT"; myTipoProceso ="CAT";}
            else if (tipoArchivo == SuirArchivoType.DependientesAdicionales)
            { arrParam[1].Value = "RD"; myTipoProceso ="RD";}
            else if (tipoArchivo == SuirArchivoType.Rectificativa)
            { arrParam[1].Value = "RT"; myTipoProceso ="RT";}
            else if (tipoArchivo == SuirArchivoType.DeclaracionFinalIR3)
            { arrParam[1].Value = "DF"; myTipoProceso ="DF";}
            else if (tipoArchivo == SuirArchivoType.Bonificacion)
            { arrParam[1].Value = "BO"; myTipoProceso ="BO";}
            else if (tipoArchivo == SuirArchivoType.DevolucionAportes)
            { arrParam[1].Value = "DA"; myTipoProceso ="DA";}
            else if (tipoArchivo == SuirArchivoType.PlanillaDGT3)
            { arrParam[1].Value = "T3"; myTipoProceso ="T3";}
            else if (tipoArchivo == SuirArchivoType.PlanillaDGT4)
            { arrParam[1].Value = "T4"; myTipoProceso ="T4";}
            else if (tipoArchivo == SuirArchivoType.EstatusDefinitivoAuditoria)
            { arrParam[1].Value = "EA"; myTipoProceso ="EA";}
            else if (tipoArchivo == SuirArchivoType.MovimientoTrabajadores)
            { arrParam[1].Value = "MO"; myTipoProceso ="MO";}
            else if (tipoArchivo == SuirArchivoType.PagoRetroactivoEnfermedadNoLaboral)
            { arrParam[1].Value = "PR"; myTipoProceso ="PR";}
            else
            {
                arrParam[1].Value = DBNull.Value;
            }
            ...
            arrParam[3] = new OracleParameter("p_usuario_carga", OracleDbType.NVarchar2, 35);
            arrParam[3].Value = this.username;
            arrParam[4] = new OracleParameter("p_id_entidad_recaudadora", OracleDbType.NVarchar2, 2);

            if (id_Entidad != null) {
                arrParam[4].Value = Convert.ToInt32(id_Entidad);
            }
            
            arrParam[5] = new OracleParameter("p_IPAddress", OracleDbType.NVarchar2, 16);
            arrParam[5].Value = IPAddress;
            arrParam[6] = new OracleParameter("p_Id_recepcion", OracleDbType.Int32);
            arrParam[6].Direction = ParameterDirection.Output;
            arrParam[7] = new OracleParameter("p_Nombre_almacenamiento", OracleDbType.NVarchar2, 1000);
            arrParam[7].Direction = ParameterDirection.Output;
            arrParam[8] = new OracleParameter("p_resultnumber", OracleDbType.NVarchar2, 2000);
            ...
            myNumero = Int32.Parse(arrParam[6].Value.ToString());
            myNombreArchivoGenerado = arrParam[7].Value.ToString();
           
            string ruta = string.Empty;

            SuirPlus.Config.Configuracion arch = new SuirPlus.Config.Configuracion(Config.ModuloEnum.ArchivosSuirPython);

            //--escribimos los archivos de recaudo en la ruta especificada
            if (tipoArchivo == SuirArchivoType.Aclaracion || tipoArchivo == SuirArchivoType.Recaudacion)
            {
                //desde aqui el nuevo codigo para el proceso de archivos de bancos
                try
                {
            ...
            {
             //escribimos los archivos diferentes de recaudo en la ruta especificada

                //ruta para corrida desde el ambiente de prueba/producción
                ruta = arch.FTPDir + myNombreArchivoGenerado;

                //ruta para corrida desde el ambiente de desarrollo
                //ruta = arch.ArchivesDir + myNombreArchivoGenerado;
            ...
            //preparamos un hilo para procesar en background el archivo posteado
        ...
        {
            Exepciones.Log.LogToDB("Iniciando exec con python");
            ...
            p.StartInfo.FileName = arch.Other3_DIR;
            p.StartInfo.WorkingDirectory = arch.Other2_DIR;

            //p.StartInfo.WorkingDirectory = Path.GetDirectoryName(arch.Other2_DIR);
            p.StartInfo.Arguments = arch.Other1_DIR + " " + '"' + arch.ArchivesDir + "" + myNombreArchivoGenerado + '"' + " " + myNumero + " " + myTipoProceso + " " + username;
            p.StartInfo.UseShellExecute = false;
            p.StartInfo.RedirectStandardError = true;
            p.StartInfo.RedirectStandardInput = true;
            p.StartInfo.RedirectStandardOutput = true;
            // p.Start();
            using (Process install = Process.Start(p.StartInfo))
            {
                result = install.StandardError.ReadToEnd();
                install.WaitForExit();
            }
            Exepciones.Log.LogToDB(result + " " + p.StartInfo.Arguments);

            //msg = result + " " + p.StartInfo.Arguments;
            //throw new Exception(result + " " + p.StartInfo.Arguments);
            //}
        }

        //para archivos de aclaracion y recaudacion
        //public void GuardarArchivo(StreamReader archivo, SuirArchivoType tipoArchivo, string rnc_cedula, string IPAddress)
        //{
        ...
        //    if (tipoArchivo == SuirArchivoType.Recaudacion)
        //    { arrParam[1].Value = "EP"; }
        //    else if (tipoArchivo == SuirArchivoType.Aclaracion)
        //    { arrParam[1].Value = "AC"; }
        //    else
        ...
        //        arrParam[1].Value = DBNull.Value;
        //    }
        //    arrParam[2] = new OracleParameter("p_RNC_CEDULA", OracleDbType.Int32);
        //    arrParam[2].Value = rnc_cedula;
        //    arrParam[3] = new OracleParameter("p_usuario_carga", OracleDbType.NVarchar2, 35);
        //    arrParam[3].Value = this.username;
        //    arrParam[4] = new OracleParameter("p_IPAddress", OracleDbType.NVarchar2, 16);
        //    arrParam[4].Value = IPAddress;
        //    arrParam[5] = new OracleParameter("p_Id_recepcion", OracleDbType.Int32);
        //    arrParam[5].Direction = ParameterDirection.Output;
        //    arrParam[6] = new OracleParameter("p_Nombre_almacenamiento", OracleDbType.NVarchar2, 1000);
        //    arrParam[6].Direction = ParameterDirection.Output;
        ...
        //    this.myNumero = Convert.ToInt32(arrParam[5].Value.ToString());
        //    this.myNombreArchivoGenerado = arrParam[6].Value.ToString();
        ...
        //**********getArchivoRespuestaPago
        public static DataTable getArchivoRespuestaPago(int? idRecepcion,string tipo)
        {
            OracleParameter[] arrParam = new OracleParameter[4];

            arrParam[0] = new OracleParameter("p_Recepcion", OracleDbType.Int32);
            if (idRecepcion.HasValue)
            {
                arrParam[0].Value = idRecepcion.Value;
            }
            else
            {
                arrParam[0].Value = DBNull.Value;
            }
            arrParam[1] = new OracleParameter("p_tipo", OracleDbType.Varchar2,1);
            arrParam[1].Value = tipo;
            ...
            String cmdStr = "sre_procesar_ep_pkg.getarchivorespuestaclob";
        ...
        public static DataTable getArchivosErroresEpAC(Int64 numerorecepcion)
        {
            ...
            String cmdStr = " sre_procesar_python_pkg.get_error_ep_ac";
        ...
        public static MemoryStream EncryptFile(MemoryStream data)
        {
            MemoryStream  outFile = new MemoryStream();
            string result = string.Empty;
            if (data != null)
            {
                string password = "elPasx4er3odj1rrelPasx4er3odj1rr";
                SuirPlus.CryptoHelp.CryptoProgressCallBack cb = new SuirPlus.CryptoHelp.CryptoProgressCallBack(ProgressCallBackEncrypt);
                outFile=SuirPlus.CryptoHelp.CryptoHelp.EncryptFileMS(data, password, cb);
            }
            return outFile;
        }
        
      public static void ProgressCallBackEncrypt(int min, int max, int value, bool done)
        {
        }
//**************************************************************************************************
        #endregion
