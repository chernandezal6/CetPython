...
{
	/// <summary>
	/// Clase para manejar las liquidaciones del INFOTEP.
	/// </summary>
	public class LiquidacionInfotep: Factura
	{
		public LiquidacionInfotep(string NroReferencia)
		{
		
			this.myConcepto = Factura.eConcepto.INF;
			this.myInstitucion = Factura.eInstitucion.INFOTEP;
			this.myNroReferencia = NroReferencia;
			this.CargarDatos();
		
		}

		public LiquidacionInfotep(Int64 NroAutorizacion)
		{
            ...
            try
                ...
                if (ds.Tables.Count > 0)
                    //if (dt.Rows.Count > 0)
                    {
                        ...
                        this.myNroReferencia = dt.Rows[0]["id_referencia_inf"].ToString();
                        ...
                        this.myTotalSalariosBonificacion = Convert.ToDecimal(dt.Rows[0]["total_salario_bonificacion"].ToString());
                        this.myTotalGeneral = Convert.ToDecimal(dt.Rows[0]["total_pago_infotep"].ToString());
