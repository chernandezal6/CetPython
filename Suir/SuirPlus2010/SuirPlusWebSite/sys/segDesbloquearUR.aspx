<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlusNoAutenticado.master" AutoEventWireup="false" CodeFile="segDesbloquearUR.aspx.vb" Inherits="sys_segDesbloquearUR" %>
                                        ...
                                        <table id="table7" cellspacing="1" width="100%" border="0">
                                            <tr>
                                                <td class="header" width="46%" colspan="2" style="text-align: center">
                                                    <font size="4">Desbloquear Usuario</font>&nbsp;
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right">
                                        <table id="table4" cellspacing="1" width="100%" border="0">
                                            <tr>
                                                <td class="header" width="46%" colspan="2" style="text-align: center">
                                                    <font size="4">Desbloquear Representante</font>
                                                </td>
                                            </tr>
                                            <tr>
