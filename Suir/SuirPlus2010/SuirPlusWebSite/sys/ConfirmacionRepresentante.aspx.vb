...
Partial Class sys_ConfirmacionRepresentante
    Inherits BasePage
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                lblMsgErr.Text = "Los datos suministrados son incorrectos, favor iniciar el proceso de actualizacion de email nuevamente."
                Exit Sub
            End If
            ...
            Try
                ...
                Dim valor As String
                resultado = SuirPlus.Empresas.Representante.ActualizarEmailRepresentante(usuario, email, params_link, "C")
                valor = Split(resultado, "|")(0)
                If valor = "0" Then
                    lblMsgOk.Visible = True
                    lblMsgOk.Text = "Su cuenta ha sido activada, ya puede ingresar al SuirPlus."
                Else
                    lblMsgErr.Visible = True
