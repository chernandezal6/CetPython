<%@ Page Language="VB" MasterPageFile="~/SuirPlain.master" AutoEventWireup="false" CodeFile="ImpEnfermedadComun.aspx.vb" Inherits="ImpEnfermedadComun" Title="Reimpresion Formulario Enfermedad Comun" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="header">
        Reimpresión Formulario Enfermedad Común</div>
    <br />
    <script type="text/javascript">
        function checkNum() {
    ...
    <script type="text/javascript">
        ...
        function ReimprimirFormulario() {
            ...
            var page = "../Novedades/sfsFormularioEnfermedadComun.aspx?numero=" + $("#<%=hfNumeroFormulario.ClientID %>").val() + "&nombre=" + $("#<%=hfnombre.ClientID %>").val() + "&cedula=" + $("#<%=hfcedula.ClientID %>").val()
                + "&nss=" + $("#<%=hfnss.ClientID %>").val() + "&sexo=" + $("#<%=hfsexo.ClientID %>").val() + "&tipoSolicitud=" + $("#<%=hftipoSolicitud.ClientID %>").val() + "&hash=" + $("#<%=hfhash.ClientID %>").val();
    ...
    <table border="0" cellpadding="1" cellspacing="1" class="tblContact" style="font-size: 13pt;
        color: #006699; font-family: Verdana" width="400px">
        <tr>
            <td>
