Imports SuirPlus
Partial Class Legal_consAcuerdosPagoCI
    Inherits BasePage
    ...
    Protected Sub bindGridView()
        ...
        Try
            dt = Legal.AcuerdosDePago.getAcuerdosPagoTipo("CI")
    ...
    Protected Sub gvAcuerdosPago_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvAcuerdosPago.RowCommand
        If e.CommandName = "Ver" Then
            ...
            Response.Redirect("consDetAcuerdoPago.aspx?Id= " & CInt(vec(0)) & "&Tipo=CI&TipoAcuerdo=" & CInt(vec(1)))
        End If
