Imports SuirPlus
Partial Class Legal_consAcuerdosPagoTS
    Inherits BasePage
    ...
    Protected Sub bindGridView()
        ...
        Try
            dt = Legal.AcuerdosDePago.getAcuerdosPagoTipo("TS")
    ...
    Protected Sub gvAcuerdosPago_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvAcuerdosPago.RowCommand
        If e.CommandName = "Ver" Then
            ...
            Response.Redirect("consDetAcuerdoPago.aspx?Id= " & CInt(vec(0)) & "&Tipo=TS&TipoAcuerdo=" & CInt(vec(1)))
        End If
