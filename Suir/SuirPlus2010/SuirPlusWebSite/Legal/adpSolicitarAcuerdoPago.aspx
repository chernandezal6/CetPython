<%@ Page Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="adpSolicitarAcuerdoPago.aspx.vb" Inherits="adpSolicitarAcuerdoPago" title="Generación de Acuerdo de Pag" %>
    ...
    <div class="header">
        ...
        <table cellpadding="1" cellspacing="0" class="td-content">
            ...
            <tr>
              ...
              <tr>
           <td align="right" style="width: 80px" nowrap ="nowrap">
                    <asp:Label ID="LblTipoAcuerdo" runat="server" Font-Bold="True" Text="Tipo Acuerdo:" nowrap="nowrap"></asp:Label></td>
            <td style="width: 121px" valign="middle">  &nbsp;
                         <asp:DropDownList ID="ddlTipoAcuerdo" runat="server" CssClass="dropDowns">
                                <asp:ListItem Selected="True" Value=""><--Seleccione--></asp:ListItem>
                                <asp:ListItem Value="Ordinario">Acuerdo Ordinario</asp:ListItem>
                                <asp:ListItem Value="Embajadas">Acuerdo Embajada</asp:ListItem>
                                 </asp:DropDownList> </td>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 273px" > 
                    &nbsp;&nbsp;<br />
                    <asp:TextBox ID="txtRNC" runat="server" EnableViewState="False" MaxLength="11" Width= "110px"></asp:TextBox>
                    <br />
    ...
    <table cellpadding="3" cellspacing="0" id="tblInfoAcuerdo" runat="server" visible="false">
        <tr>
            <td align="right" style="text-align: left" colspan="2" >
                ...
                <asp:Label ID="lblprovincia" runat="server" Font-Bold="True" Visible="False"></asp:Label></td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td align="right" colspan="2" style="text-align: left">
                <asp:GridView ID="gvNotificaciones" runat="server" AutoGenerateColumns="False" CellPadding="3">
                    <Columns>
                        ...
                        <asp:BoundField DataField="Periodo_Formateado" HeaderText="Periodo" >
