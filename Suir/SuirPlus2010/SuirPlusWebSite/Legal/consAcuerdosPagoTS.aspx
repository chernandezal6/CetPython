<%@ Page Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="consAcuerdosPagoTS.aspx.vb" Inherits="Legal_consAcuerdosPagoTS" title="Consulta de Acuerdos de Pago - Tesorero" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
		<script language="vb" runat="server">
			Private Sub Cargar_Seguridad(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Init
		        ...
		        Me.PermisoRequerido = 157
				
			End Sub
		</script>
<div class="header" align="left"> Acuerdos de Pago pendientes de firma</div>
    <asp:Label ID="lblMsg" runat="server" Visible="False" CssClass="error" Font-Bold="True" Font-Size="11pt"></asp:Label><br />
