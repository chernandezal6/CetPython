...
Partial Class Mantenimientos_ListadoEvaluacionPasaportes
    Inherits BasePage
    ...
    Protected Sub Page_Load1(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            If Not IsNothing(Request.QueryString("CasoEvaluacion")) Then
                ddlEstatus.SelectedValue = Request.QueryString("CasoEvaluacion")
            End If
            cargarDatos()
        End If
    ...
    Private Sub cargarDatos()
        ...
        dt = SuirPlus.Mantenimientos.Mantenimientos.getPasaportes(UsrRegistroPatronal, txtPasaporte.Text, UsuarioLogueado, txtNombres.Text, txtPrimerApellido.Text, txtsegundoApellido.Text, txtFechaDesde.Text, txtFechaHasta.Text, ddlEstatus.SelectedValue, pageNum, PageSize)
    ...
    Protected Sub gvListado_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gvListado.RowCommand
        ...
        Dim Caso = e.CommandArgument.ToString()

        If e.CommandName = "E" Then
            id = e.CommandArgument.ToString()
            Response.Redirect("~/Mantenimientos/EvaluarPasaportes.aspx?id_solicitud=" & Caso)
        End If
    ...
    Protected Sub gvListado_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gvListado.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            CType(e.Row.Cells(7).FindControl("ibPasaporteEvaluar"), ImageButton).Visible = True
        End If
    End Sub

    'Protected Sub ddlEstatus_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ddlEstatus.SelectedIndexChanged
    '    pageNum = 1
