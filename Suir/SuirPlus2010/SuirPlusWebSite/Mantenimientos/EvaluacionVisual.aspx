<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="EvaluacionVisual.aspx.vb" Inherits="Mantenimientos_EvaluacionVisual" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="header" align="left">
        ...
        <fieldset id="fsCasosEvaluacion" style="height:60px; width: 300px">
            ...
            <table>
                <tr>
                    <td align="right" style="height: 20px">Evaluar:
                    </td>
                    <td style="height: 20px">
                        <asp:DropDownList ID="ddlCasosEvaluacion" runat="server" CssClass="dropDowns" AutoPostBack="True">
                            ...
                            <asp:ListItem Value="F" Text="Fallecidos"></asp:ListItem>
                            <asp:ListItem Value="P" Text="Pasaportes"></asp:ListItem>
...
<asp:GridView ID="gvListado" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Asignacion" HeaderText="Tipo Evaluación">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle Wrap="False" CssClass="tdevaluacion" />
                </asp:BoundField>
                <asp:BoundField DataField="IDNSS" HeaderText="NSS">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle CssClass="tdevaluacion" />
                </asp:BoundField>
                <%--<asp:BoundField DataField="ID" HeaderText="Tipo Solicitud">
                    <HeaderStyle HorizontalAlign="Center" />
                </asp:BoundField>--%>
                ...
                <asp:TemplateField>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:ImageButton ID="ibEvaluarFallecido" runat="server" Visible="false" ImageUrl="~/images/kappfinder.gif" CommandName="F" CommandArgument='<%# Eval("IdRow")%>' />
                        <asp:ImageButton ID="ibEvaluarMayoriaEdad" runat="server" Visible="false" ImageUrl="~/images/kappfinder.gif" CommandName="N" CommandArgument='<%# Eval("ID_SOLICITUD")%>' />
                        <asp:ImageButton ID="ibEvaluarPasaporte" runat="server" Visible="false" ImageUrl="~/images/kappfinder.gif" CommandName="P" CommandArgument='<%# Eval("id_solicitud")%>' />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
