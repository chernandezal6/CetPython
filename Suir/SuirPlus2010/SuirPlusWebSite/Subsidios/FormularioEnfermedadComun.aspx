<%@ Page Language="VB" MasterPageFile="~/SuirPlain.master" AutoEventWireup="false" CodeFile="FormularioEnfermedadComun.aspx.vb" Inherits="Novedades_sfsFormularioEnfermedadComun" title="Formulario de Solicitud de Subsidio por Enfermedad Comun" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <td colspan="2" valign="top" style="height: 31px;">
                            <table border="1" cellpadding="0" cellspacing="0" frame="void" 
                                ...
                                <tr>
                                    ...
                                    <td valign="top" width="40%">
                                        &nbsp;<&nbsp; Días Calendarios Ambulatorios:</span></td>
                                </tr>
                            </table>
                        </td>
        </tr>
       ...
       <td colspan="2" valign="top" style="height: 31px;">
                            <table border="1" cellpadding="0" cellspacing="0" frame="void" 
                                ...
                                <tr>
                                    <td valign="top" width="60%">
                                        <span style="font-size: 12px" >&nbsp;Fecha de inicio de Licencia o Renovación Hospitalaria(*):</span></td>
                                    <td valign="top" width="40%">
                            ...
                            <table border="1" cellpadding="0" cellspacing="0" frame="void" 
                                ...
                                <tr>
                                    <td style="height: 68px;" valign="top" width="%">
                                        <span style="font-size: 12px" >&nbsp;Fecha de Diagnóstico:&nbsp;sp;Fecha de Diagnóstico:&nbsp;</span></td>
