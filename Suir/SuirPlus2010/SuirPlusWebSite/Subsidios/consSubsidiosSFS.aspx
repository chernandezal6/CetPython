<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false"
    CodeFile="consSubsidiosSFS.aspx.vb" Inherits="Subsidios_consSubsidiosSFS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:UpdatePanel ID="upSubsidiosSFS" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <fieldset style="width: 300px; height: 120px;">
                            ...
                            <asp:GridView ID="gvSubsidiosSFS" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="" Visible="true">
                                        <ItemStyle HorizontalAlign="Center" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblEstatus" runat="server" Text='<%# Eval("descripcion") %>' Visible="False"></asp:Label>
                                            <asp:Label ID="lblDefinitivo" runat="server" Text='<%# Eval("definitivo") %>' Visible="False"></asp:Label>

                                            <asp:LinkButton ID="lbReconsiderar" runat="server" CommandName="Rec" CommandArgument='<%# Eval("nro_solicitud") &"|"& Eval("id_tipo_subsidio")&"|"&Eval("IdRegistro") %>'>Reconsiderar</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
