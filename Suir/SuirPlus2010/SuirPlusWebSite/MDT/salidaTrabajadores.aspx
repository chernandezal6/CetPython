<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlusLite.master" AutoEventWireup="false"
    CodeFile="salidaTrabajadores.aspx.vb" Inherits="MDT_salidaTrabajadores" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
           ...
           // pagaMDT();
            ...
            Util.AgregarTip('txtFechaSalida', 'Se indicará el día, mes y año en que el trabajador dejó de laborar en la empresa, ejemplo: "El trabajador dejó de laborar el 12 de mayo de 2000.(12/05/2000)"');
...
//                    };
                    Util.LlamarServicio('MDT.asmx', 'getInformacionTrabajador', ParamsCiudadano, function (data) {
                        ...
                        if (info != "error") {
                           ...
                           // $("#ddlPlanilla").val(data.d.id_planilla);
                            ...
                            if (Util.formatJSONDate(data.d.vacaciones_desde, "dd/mm/yyyy") != "01/01/1")
                            { $("#TxtVacacionDesde").val(Util.formatJSONDate(data.d.vacaciones_desde, "dd/mm/yyyy")); }


                            if (Util.formatJSONDate(data.d.vacaciones_hasta, "dd/mm/yyyy") != "01/01/1")
                            { $("#TxtVacacionHasta").val(Util.formatJSONDate(data.d.vacaciones_hasta, "dd/mm/yyyy")); }
        ...
        function ProcesarTrabajador() {
            ...
            var ParamsTrabajador = {
                ...
                fechaNovedad: $("#txtFechaSalida").val(),
        ...
        function validaciones() {
            ...
            if ($("#txtFechaSalida").val() != "") {
                if (!Util.ValidarFecha($("#TxtVacacionDesde").val())) {
                    Resultado += "* Debe ingresar una fecha de salida válida.</br>";
                }
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <span class="header">Salida de trabajadores MDT</span>
    <div id="divConsultaCiudadano">
        <!-- Estos Span son Utilizados para los Autocomplete y los Dropdown-->
        <span id="RegistroPatronal" style="visibility: hidden"><%=UsrRegistroPatronal%></span> <span id="NSS" style="visibility: hidden"></span>
        <span id="UsuarioCreador" style="visibility: hidden"><%=UsrUserName%></span> <span id="PuestoValue" style="visibility: hidden"></span>
        <!-- ---------------------------------------------------------------->
    ...
    <div id="divFormulario">
        <table class="td-content">
            ...
            <tr>
                ...
                <td>
                    <input id="txtFechaSalida" type="text" value="" class="fecha"
                </td>
            </tr>
            <tr>
                <td>
    ...
    </div>            <div id="ControlNovedadesPendientes">
