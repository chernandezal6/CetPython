<%@ Page Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="ManejoArchivo.aspx.vb" Inherits="Afiliacion_ManejoArchivo" title="Manejo de Archivos - SUIR Plus" %>
...
<tr>
    <td>
            ...
            <asp:panel id="pnlCargaArchivo" runat="server">
                <table cellpadding="2" cellspacing="0" class="tblWithImagen" 
                    style="width: 425px; ">
                    <tr>
