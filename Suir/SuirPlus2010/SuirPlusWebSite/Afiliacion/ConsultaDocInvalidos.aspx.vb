Imports System.Data
Imports SuirPlus
Partial Class ConsultaDocInvalidos
    Inherits BasePage
...
#End Region
    ...
    Private Sub LoadData()
        ...
        dtTSS = Afiliacion.Afiliaciones.getDocumentosInvalidos(Me.txtDesde.Text, Me.txtHasta.Text, getARSUsuario, Me.PageSize, Me.pageNum)
        ...
        If dtTSS.Rows.Count > 0 Then
            ...
            setNavigation()
        Else
            Me.lblMensaje.Text = "No existen registro para esta busqueda"
            Me.gvArchivos.DataSource = dtTSS
            Me.gvArchivos.DataBind()
    ...
    Protected Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click
        If Not String.IsNullOrEmpty(Me.txtDesde.Text) And Not String.IsNullOrEmpty(Me.txtHasta.Text) Then
            ...
            End If
        Else
            lblMensaje.Text = "Debe elegir una fecha desde y una hasta."
        End If
    End Sub

   
    Protected Sub btnLimpiar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLimpiar.Click
        Response.Redirect("ConsultaDocInvalidos.aspx")
    End Sub
