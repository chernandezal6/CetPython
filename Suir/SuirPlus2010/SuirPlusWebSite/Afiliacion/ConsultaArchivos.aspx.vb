Imports System.Data
Imports SuirPlus
Partial Class SEH_ConsultaArchivos
    Inherits BasePage
...
#End Region
    ...
    Private Sub LoadData()
        ...
        dtTSS = Afiliacion.Afiliaciones.getArchivosPaginados(ddlTipo.SelectedValue, desde, hasta, getARSUsuario, Me.PageSize, Me.pageNum)
    ...
    Protected Sub gvArchivos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvArchivos.RowCommand
        If e.CommandName = "Ver" Then
            ...
            Try
                ...
                ImgAcuerdo = Afiliacion.Afiliaciones.getArchivo(IDArchivo)
