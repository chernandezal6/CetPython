...
Partial Class Novedades_novIngreso
    Inherits BasePage
...
#End Region
    ...
    Private Sub iniForm()
        ...
        Me.ucFechaIngreso.dateValue = Now.Date
    ...
    Private Sub novedadesPendientes()
        Try
            ...
            'Si es Usuario
            tmpDataTable = SuirPlus.Empresas.Trabajador.getMovimientos(Me.UsrRegistroPatronal, "NV", "IN", "I", Me.UsrRNC & Me.UsrCedula)


            UcGridNovPendientes1.bindNovedades(Me.UsrRegistroPatronal, "NV", "IN", "I", Me.UsrRNC & Me.UsrCedula)
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        'If String.IsNullOrEmpty(Me.txtSalarioSS.Text) Then
        '    Me.txtSalarioSS.Text = "0.00"
        'Else
        '    If Not isDecimal(Me.txtSalarioSS.Text) Then
        ...
        If Not ucFechaIngreso.isValid Then
        ...
        Try
            ret = SuirPlus.Empresas.Trabajador.novedadIngreso(Me.UsrRegistroPatronal, Me.ddNomina.SelectedValue, Me.ucEmpleado.getNSS, Me.txtSalarioSS.Text, Me.txtAporteVoluntario.Text, Me.txtSalarioISR.Text, Me.txtSalarioINF.Text, Me.txtAgenteRetencionISR.Text, Me.txtOtrasRemuneraciones.Text, Me.txtRemuneracionesOtroEmp.Text, Me.ucFechaIngreso.dateValue, Me.txtIngresoExento.Text, Me.txtSaldoFavor.Text, Me.UsrUserName, Me.ddTipoIngreso.SelectedValue, Me.GetIPAddress())
