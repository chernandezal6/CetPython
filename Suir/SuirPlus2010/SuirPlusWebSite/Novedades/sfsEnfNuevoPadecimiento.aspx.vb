...
Partial Class Novedades_sfsEnfNuevoPadecimiento
    Inherits BasePage
...
#Region "Eventos"
    ...
    Protected Sub btnConsultar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        ...
        If validaciones.Equals("OK") Then
            'Validacion2: Tiene un formulario pendiente de completar?, si la funcion trae datos, tiene opcion de completar los datos,
            'se presenta el formulario para qeu se llenen los datos iniciales y se inserte el formulario pendiente de completar
            If Not IsNothing(formPendiente) Then
                If CargarInfoEmpleado() Then
                    If formPendiente.Rows.Count > 0 Then
                        LoadDatosIniciales(formPendiente)
                        ViewState("NumeroFormulario") = formPendiente.Rows(0)("NroSolicitud").ToString
                    Else
                        LoadNuevoFormulario()
                    End If
                End If
    ...
    Protected Sub btnRegistrarDatosIniciales_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRegistrarDatosIniciales.Click
        ...
        Try
            ...
            RegistrarDatosIniciales(CInt(ucInfoEmpleado1.NSS.Replace("-", "")), "Nueva", nroFormulario, _
