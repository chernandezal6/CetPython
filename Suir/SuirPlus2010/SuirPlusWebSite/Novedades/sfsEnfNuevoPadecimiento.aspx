<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="sfsEnfNuevoPadecimiento.aspx.vb" Inherits="Novedades_sfsEnfNuevoPadecimiento" %>
...
<script language="javascript" type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var hidEmp = $("#ctl00_MainContent_hidInfoEmpleado").val();

        //show divInfoEmpleado
        if (hidEmp == true) {
            $("#ctl00_MainContent_divInfoEmpleado").show('slow');
        }
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <ContentTemplate>
        ...
        <span class="header">Nuevo Padecimiento</span>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left">
                                                                <asp:TextBox ID="txtDiscapFechaDiagnostico" runat="server" 
                                                                    CssClass="fecha" AutoPostBack="False"></asp:TextBox>
