    ...
    Private Sub CargarDatos()
        ...
        Try
            If Not IsNothing(Request.QueryString) Then
                ...
                Me.lblNumeroFormulario.Text = SuirPlus.Empresas.SubsidiosSFS.EnfermedadComun.unhashValores(Request.QueryString("numero").ToString())
                ...
                Me.ckF.Checked = Request.QueryString("sexo").ToString().Equals("F")
                Me.ckM.Checked = Request.QueryString("sexo").ToString().Equals("M")
