...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        next: $('<a validar="0">Siguiente</a>').attr("href", "#").addClass("buttonNext"),
        //previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious"),
        previous: $('<a validar="0">Anterior</a>').attr("href", "#").addClass("buttonPrevious"),
        //finish  : $('<a>'+options.labelFinish+'</a>').attr("href","#").addClass("buttonFinish")
        finish: $('<a>Finalizar</a>').attr("href", "#").addClass("buttonFinish")
    };
    ...
    var _init = function ($this) {
        ...
        $($this.buttons.next).click(function () {
            ...
            var Atributo = $this.buttons.next.attr("validar");
            if (Atributo == "0") {
                this.curStepIdx = this.curStepIdx + 3;
                $this.goForward();
            } else {
        ...
        $($this.buttons.previous).click(function () {
            ...
            var Atributo = $this.buttons.previous.attr("validar");
            if (Atributo == "0") {
                $this.goBackward();
            } else {
