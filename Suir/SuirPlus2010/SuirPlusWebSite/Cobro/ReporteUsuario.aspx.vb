...
#Region "Metodos de la pagina"
    ...
    Private Sub LoadData()
        ...
        Dim dt = Cobro.getReporteCobros(Me.UsrUserName)
        ...
        If e.CommandName = "DetalleSeguimieto" Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                If Utilitarios.Utils.HayErrorEnDataTable(dt) = False Then
                    ...
                    Dim dvDetalle As DataView = dt.DefaultView

                    dvDetalle.RowFilter = "usuario = '" & Me.UsrUserName & "'"

                    gvdetalleseguimiento.DataSource = dvDetalle
