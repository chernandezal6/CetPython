...
Partial Class Certificaciones_CrearCertificacionRep
    Inherits BasePage
    ...
    Protected Sub cargarfirmas()
        Try
            ...
            Me.dlFirmaResponsable.SelectedValue = 12
            Me.dlFirmaResponsable.Enabled = False
    ...
    Private Sub btnNuevaCert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNuevaCert.Click
        ...
        Response.Redirect("CrearCertificacionRep.aspx")
...
#Region "Metodos Privados y Configuracion de paneles"
    ...
    Private Sub MuestraPanelFinal()
        ...
        Me.lblNoCert.Text = myCert.NoCertificacion
