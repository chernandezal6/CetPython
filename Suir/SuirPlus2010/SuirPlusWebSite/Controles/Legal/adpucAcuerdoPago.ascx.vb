    ...
    Public Sub _MostrarData()
        Try
            ...
            If Me.myNroAcuerdoDePago <> 0 Then
                ...
                Dim acP As New SuirPlus.Legal.AcuerdosDePago(Me.myNroAcuerdoDePago, SuirPlus.Legal.eTiposAcuerdos.Ordinario)
                ...
                'Llenar el ds
                Dim dt As DataTable
                dt = SuirPlus.Legal.AcuerdosDePago.getDetAcuerdoPago(acP.idAcuerdo, SuirPlus.Legal.eTiposAcuerdos.Ordinario)
    ...
    Private Sub LlenarGrid()
        Try
            ...
            If Me.myNroAcuerdoDePago <> 0 Then
                ...
                Me.gvCuotas.DataSource = SuirPlus.Legal.AcuerdosDePago.getDetAcuerdoPagoFechaLimite(Me.myNroAcuerdoDePago, SuirPlus.Legal.eTiposAcuerdos.Ordinario)
