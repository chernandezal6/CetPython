...
Partial Class Controles_ucAcuerdoPagoEmbajadas
    ...
    Public Sub _MostrarData()
        Try
            ...
            If Me.myNroAcuerdoDePago <> 0 Then
                ...
                Dim acP As New SuirPlus.Legal.AcuerdosDePago(Me.myNroAcuerdoDePago, SuirPlus.Legal.eTiposAcuerdos.Embajadas)

                myDC.CargoRepresentante = acP.Cargo
                myDC.Direccion = acP.Direccion
                myDC.Provincia = acP.Provincia
                ...
                'Llenar el ds
                Dim dt As DataTable
                dt = SuirPlus.Legal.AcuerdosDePago.getDetAcuerdoPago(acP.idAcuerdo, SuirPlus.Legal.eTiposAcuerdos.Embajadas)
            ...
            'Me.lblProvincia.Text = myDC.Provincia
            ...
            Me.lblPeriodoDesde.Text = SuirPlus.Utilitarios.Utils.FormateaPeriodo(myDC.PeriodoIni)
            Me.lblPeriodoHasta.Text = SuirPlus.Utilitarios.Utils.FormateaPeriodo(myDC.PeriodoFin)
    ...
    Private Sub LlenarGrid()
        Try
            ...
            If Me.myNroAcuerdoDePago <> 0 Then
                ...
                Me.gvCuotas.DataSource = SuirPlus.Legal.AcuerdosDePago.getDetAcuerdoPagoFechaLimite(Me.myNroAcuerdoDePago, SuirPlus.Legal.eTiposAcuerdos.Embajadas)
