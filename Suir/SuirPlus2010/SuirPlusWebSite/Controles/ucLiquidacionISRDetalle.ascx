<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLiquidacionISRDetalle.ascx.vb" Inherits="Controles_ucLiquidacionISRDetalle" %>
...
<table cellpadding="0" cellspacing="0" style="width:950px;">
    <tr>
        <td>
            <asp:Label ID="Label1" runat="server" CssClass="subHeader">Detalle de la liquidación de ISR Nro.: </asp:Label><asp:Label
                ID="lblTitulo" runat="server" CssClass="subHeaderContrast"></asp:Label><br/>
            <asp:Label ID="Label2" runat="server" CssClass="subheader">Total de la Liquidación: </asp:Label><asp:Label
                ID="lblTotal" runat="server" CssClass="subHeaderContrast"></asp:Label><br/>
        ...
        <td>
            <asp:GridView ID="gvDetalle" runat="server" autogeneratecolumns="false">
                <Columns>
					...
					<asp:BoundField DataField="ISR" HeaderText="ISR" HtmlEncode="false" DataFormatString="{0:n}">
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundField>
					...
					<asp:BoundField DataField="Saldo_compensado" HeaderText="S.F.C." HtmlEncode="false" DataFormatString="{0:n}">
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundField>
					<asp:BoundField DataField="saldo_por_compensar" HeaderText="S.P.C." HtmlEncode="false" DataFormatString="{0:n}">
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundField>
					<asp:BoundField DataField="impuesto_pagar" HeaderText="Impuesto a Pagar" HtmlEncode="false" DataFormatString="{0:n}">
						<ItemStyle HorizontalAlign="Right"></ItemStyle>
					</asp:BoundField>
				</Columns>                
            </asp:GridView>
            ...
            <table id="tblLeyenda" border="0" cellpadding="1" cellspacing="1" class="td-note"
                ...
                <tr>
                    <td>
                        S.F.C.</td>
                    <td>
                        Saldo a Favor Compensado</td>
                </tr>
                <tr>
                    <td>
                        S.P.C.</td>
                    <td>
                        Saldo a Favor por Compensar</td>
                </tr>
            </table>
        </td>
        <td>
