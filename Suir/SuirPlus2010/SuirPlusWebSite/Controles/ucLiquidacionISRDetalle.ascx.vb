...
Partial Class Controles_ucLiquidacionISRDetalle
    Inherits BaseCtrlFacturaDetalle
    Protected Liquidacion As SuirPlus.Empresas.Facturacion.LiquidacionISR
...
#End Region
    ...
    Protected Sub bindGrid()
        ...
        Try
            dtDetalle = SuirPlus.Empresas.Facturacion.LiquidacionISR.getDetalleFactura(Me.NroReferencia, SuirPlus.Empresas.Facturacion.Factura.eConcepto.ISR.ToString(), Me.pageNum, Me.PageSize)
    ...
    Protected Sub fillLabels()
        ...
        Liquidacion = New SuirPlus.Empresas.Facturacion.LiquidacionISR(Me.NroReferencia)

        SuirPlus.Operaciones.RegistroLogAuditoria.CrearRegistro(Liquidacion.RegistroPatronal, HttpContext.Current.Session("UsrUserName"), HttpContext.Current.Session("UsrUserName"), 4, Request.UserHostAddress, Request.UserHostName, Me.NroReferencia, Request.ServerVariables("LOCAL_ADDR"))

        Me.lblTitulo.Text = Liquidacion.NroReferenciaFormateado
        Me.lblTotal.Text = String.Format("{0:c}", Liquidacion.TotalGeneral)
        Me.lblPeriodo.Text = Liquidacion.PeriodoFormateado
    ...
    Protected Sub ucExpExcel_ExportaExcel(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucExpExcel.ExportaExcel
        ...
        Me.ucExpExcel.DataSource = SuirPlus.Empresas.Facturacion.LiquidacionISR.getDetFacturaNoPaging(Me.NroReferencia, SuirPlus.Empresas.Facturacion.Factura.eConcepto.ISR.ToString())
