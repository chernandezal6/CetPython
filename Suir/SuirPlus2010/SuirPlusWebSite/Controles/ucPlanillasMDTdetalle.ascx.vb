...
Partial Class Controles_ucPlanillasMDTdetalle
    Inherits BaseCtrlFacturaDetalle
    Protected Planilla As SuirPlus.Empresas.Facturacion.PlanillaMDT
...
#End Region
    ...
    Protected Sub bindGrid()
        ...
        Try
            dtDetalle = SuirPlus.Empresas.Facturacion.FacturaSS.getDetalleFactura(Me.NroReferencia, SuirPlus.Empresas.Facturacion.Factura.eConcepto.MDT.ToString(), Me.pageNum, Me.PageSize)
    ...
    Protected Sub fillLabels()
        ...
        Planilla = New SuirPlus.Empresas.Facturacion.PlanillaMDT(Me.NroReferencia)

        SuirPlus.Operaciones.RegistroLogAuditoria.CrearRegistro(Planilla.RegistroPatronal, HttpContext.Current.Session("UsrUserName"), HttpContext.Current.Session("UsrUserName"), 4, Request.UserHostAddress, Request.UserHostName, Me.NroReferencia, Request.ServerVariables("LOCAL_ADDR"))

        Me.lblNoReferencia.Text = Planilla.NroReferenciaFormateado
        Me.lblTotalFactura.Text = String.Format("{0:c}", Planilla.TotalGeneral)
        Me.lblPeriodoFactura.Text = Planilla.PeriodoFormateado
    ...
    Protected Sub UcExp_ExportaExcel(ByVal sender As Object, ByVal e As System.EventArgs) Handles UcExp.ExportaExcel
        ...
        UcExp.DataSource = gvDetalle.DataSource
