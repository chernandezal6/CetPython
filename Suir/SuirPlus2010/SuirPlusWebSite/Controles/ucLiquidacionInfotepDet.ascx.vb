...
Partial Class Controles_ucLiquidacionInfotepDet
    Inherits BaseCtrlFacturaDetalle
    Protected Liquidacion As SuirPlus.Empresas.Facturacion.LiquidacionInfotep
...
#End Region
    ...
    Protected Sub bindGrid()
        ...
        Try
            dtDetalle = SuirPlus.Empresas.Facturacion.FacturaSS.getDetalleFactura(Me.NroReferencia, SuirPlus.Empresas.Facturacion.Factura.eConcepto.INF.ToString(), Me.pageNumInf, Me.PageSizeInf)
    ...
    Protected Sub fillLabels()
        ...
        Liquidacion = New SuirPlus.Empresas.Facturacion.LiquidacionInfotep(Me.NroReferencia)
        ...
        Me.lblNoReferencia.Text = Liquidacion.NroReferenciaFormateado
        Me.lblTotalFactura.Text = String.Format("{0:c}", Liquidacion.TotalGeneral)
        Me.lblPeriodoFactura.Text = Liquidacion.PeriodoFormateado
    ...
    Protected Sub UcExp_ExportaExcel(ByVal sender As Object, ByVal e As System.EventArgs) Handles UcExp.ExportaExcel
        ...
        UcExp.DataSource = Liquidacion.getDetalle
    End Sub
End Class
