...
Partial Class Controles_ucNotificacionTSSDetalleSIPEN
...
#End Region
    ...
    Protected Sub ucExpExcel_ExportaExcel(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucExpExcel.ExportaExcel
        ...
        Me.ucExpExcel.DataSource = SuirPlus.Empresas.Facturacion.Factura.getDetalleFacturaSipenNoPaging(Me.NroReferencia)
