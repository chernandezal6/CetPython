...
Partial Class Controles_ucNotificacionTSSDetalleAuditoria
    Inherits BaseCtrlFacturaDetalle

    Private Notificacion As SuirPlus.Empresas.Facturacion.FacturaSS
...
#End Region
    ...
    Protected Sub bindGrid()
        ...
        Dim dtDetalle As Data.DataTable = Nothing

        Try
            dtDetalle = SuirPlus.Empresas.Facturacion.FacturaSS.getDetalleFacturaAuditoria(Me.NroReferencia, Me.pageNum, Me.PageSize)
    ...
    Protected Sub ucExpExcel_ExportaExcel(ByVal sender As Object, ByVal e As System.EventArgs) Handles ucExpExcel.ExportaExcel
        ...
        Me.ucExpExcel.DataSource = SuirPlus.Empresas.Facturacion.Factura.getDetalleFacturaAuditoriaNoPaging(Me.NroReferencia)
