<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="ArchivosProcesados.aspx.vb" Inherits="Bancos_ArchivosProcesados" %>
...
<%--        <tr>
    ...
    <asp:Panel ID="pnlResultado" runat="server" Visible="False">
        <table id="table8" border="0" cellpadding="0" cellspacing="3" class="td-note" width="650">
            <tr>
                <td class="LabelDataGreen" rowspan="rowspan">Número de Envío:</td>
                <td style="text-align:left"><asp:Label ID="lblIdRecepcion" runat="server" CssClass="LabelDataGris"></asp:Label></td>
                <td class="LabelDataGreen">Estatus:</td>
                <td style="text-align:left"><asp:Label ID="lblEstatus" runat="server" CssClass="LabelDataGris"></asp:Label></td>
                </tr><tr>
                <td class="LabelDataGreen">Resultado:</td>
