<%@ Page Title="Recaudo Ibanking" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="RecaudoIbanking.aspx.vb" Inherits="Reportes_RecaudoIbanking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="divTitulo" class="header">
        <asp:Label ID="lblTitulo" runat="server" Text="Recaudo IBanking"> 
        </asp:Label>
    </div>
    <br />
    ...
    <asp:Panel ID="pnlRecaudoIbanking" runat="server" Visible="false">
        <rsweb:ReportViewer ID="rvRecaudoIbanking" runat="server" Font-Names="Verdana"
            Font-Size="8pt" Height="600px" Width="100%" ZoomPercent="100" PageCountMode="Estimate">
            <LocalReport ReportPath="Reportes\Recaudo_Ibanking_Por_RangoFechas.rdlc"></LocalReport>
        </rsweb:ReportViewer>
