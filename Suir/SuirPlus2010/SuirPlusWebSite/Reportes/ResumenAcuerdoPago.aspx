<%@ Page Title="" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="ResumenAcuerdoPago.aspx.vb" Inherits="Reportes_ResumenAcuerdoPago" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="divTitulo" class="header">
        <asp:Label ID="lblTitulo" runat="server" Text="Resumen Acuerdo Pago Completado"> 
        </asp:Label>
    </div>
    <br />
    ...
    <br />
    <br />
    <asp:Panel ID="pnlResumenAcuerdoPago" runat="server" Visible="false">
        <rsweb:ReportViewer ID="rvResumenAcuerdoPago" runat="server" Font-Names="Verdana"
            Font-Size="8pt" Height="600px" Width="100%" ZoomPercent="100" PageCountMode="Estimate">
            <LocalReport ReportPath="Reportes\ResumenAcuerdoPago.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </asp:Panel>
</asp:Content>
