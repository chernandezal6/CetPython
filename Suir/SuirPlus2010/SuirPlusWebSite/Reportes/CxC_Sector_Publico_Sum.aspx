<%@ Page Title="Cuentas x Cobrar Sector Público Con Sub-Totales" Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="CxC_Sector_Publico_Sum.aspx.vb" Inherits="Reportes_CxC_Sector_Publico_Sum" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="divTitulo" class="header">
        <asp:Label ID="lblTitulo" runat="server" Text="Cuentas x Cobrar Sector Público Con Sub-Totales"> 
        </asp:Label>
    </div>
    <br />
    ...
    <asp:Panel ID="pnlReporte" runat="server" Visible="false">
        <rsweb:ReportViewer ID="rvCxCSectorPublico" runat="server" Font-Names="Verdana"
            ...
            <LocalReport ReportPath="Reportes\CxC_Sector_Publico_Sum.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
