...
Partial Class Asignacion_NSS_ConsAsignacionNSSEmpleador
    Inherits BasePage
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If UsrRegistroPatronal <> String.Empty Then
                Dim repEmpresa As New Repositories.EmpresaRepository()
                Dim empresa = repEmpresa.GetByRegistroPatronal(UsrRegistroPatronal)
                lblRnc.Text = empresa.RncCedula
                lblRnc.Visible = True
    ...
    Private Sub CargarEstatus()
        Try
            ...
            ddlEstatus.DataBind()
            ddlEstatus.Items.Add(New ListItem("Todos", ""))
    ...
    Private Sub llenarDataGridSolicitud()
        ...
        Dim sol = repSolicitud.GetSolicitudRnc(UsrRNC, ddlEstatus.SelectedValue, txtFechaDesde.Text, txtFechaHasta.Text, pageNum, PageSize)
    ...
    Private Sub btBuscar_Click(sender As Object, e As EventArgs) Handles btBuscar.Click
        ...
        If (txtFechaDesde.Text <> String.Empty And txtFechaHasta.Text = String.Empty) Or (txtFechaDesde.Text = String.Empty And txtFechaHasta.Text <> String.Empty) Then
            lblMensajeError.Text = "Ambas fechas son requeridas."
            lblMensajeError.Visible = True
        Else
    ...
    Private Sub btLimpiar_Click(sender As Object, e As EventArgs) Handles btLimpiar.Click
        Response.Redirect("ConsAsignacionNSSEmpleador.aspx")
    End Sub
