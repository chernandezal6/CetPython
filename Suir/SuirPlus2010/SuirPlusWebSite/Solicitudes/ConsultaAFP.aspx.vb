...
Partial Class Solicitudes_ConsultaAfp
    ...
    Protected Sub Solicitudes_ConsultaAfiliado_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            If recaptcha.IsValid Then
                ...
                Try
                    ...
                    Dim ProxyUser As String = System.Configuration.ConfigurationManager.AppSettings("ProxyUser")
                    Dim ProxyIP As String = System.Configuration.ConfigurationManager.AppSettings("ProxyIP")
                    Dim ProxyDomain As String = System.Configuration.ConfigurationManager.AppSettings("ProxyDomain")
                    Dim ProxyPort As String = System.Configuration.ConfigurationManager.AppSettings("ProxyPort")

                    Dim ProxyPass As String = System.Configuration.ConfigurationManager.AppSettings("ProxyPass")
                    ...
                    Dim Usuario As String = System.Configuration.ConfigurationManager.AppSettings("UsuarioWebServiceUNIPAGO")
                    Dim Pass As String = System.Configuration.ConfigurationManager.AppSettings("PasswordWebServiceUNIPAGO")
