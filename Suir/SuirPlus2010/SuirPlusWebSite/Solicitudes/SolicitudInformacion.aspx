<%@ Page Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="SolicitudInformacion.aspx.vb" Inherits="Solicitudes_SolicitudInformacion" Title="Solicitud de información" %>
    ...
    <table align="center" class="td-content" id="table1" width="600px" cellspacing="2" cellpadding="1" border="0">
        ...
        <tr>
            <td align="right" width="30%">
                ...
                <br /><asp:Label ID="lblVersion" runat="server" Font-Bold="True" Text="Versión 2.0"></asp:Label>
            </td>
            <td>
                &nbsp;</td>
        </tr>
        ...
        <tr>
            <td align="right" class="labelData">Correo Electrónico:
            </td>
            <td>
        ...
        <tr>
            <td align="right" class="labelData">Lugar para recibir la información:
            </td>
            <td>
