<%@ Page Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="SolNovedades.aspx.vb" Inherits="Solicitudes_SolNovedades" title="Novedades Registro de Nominas" %>
<%@ Register TagPrefix="uc1" TagName="UCTelefono" Src="../Controles/UCTelefono.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
					<br />
	                  <div align="center" class="header">Novedades &amp; Registro de Nóminas</div>
                    <br />
			...
			<TABLE class="td-content" id="Table1" cellSpacing="2" cellPadding="1" width="550" border="0">
				...
				<TR>
					<TD align="right">Información de Solicitud&nbsp;</TD>
					<TD colSpan="3">
			...
			<div align="center">
			<asp:Label cssClass="error" id="lblMensaje" runat="server" EnableViewState="False"></asp:Label></div><BR>
			</TD>
		</TR>
	</TABLE>
</asp:Content>
