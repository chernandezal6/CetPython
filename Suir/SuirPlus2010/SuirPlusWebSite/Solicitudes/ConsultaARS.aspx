...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel ID="pnlInfo" runat="server" Visible="False" Width="543px">
        <table border="0" cellpadding="0" cellspacing="0" id="TABLE2" runat="server" visible="true" width="370">
            ...
            <tr>
                <td style="width: 106px; height: 16px">
                    <asp:Label ID="Label2" runat="server" Font-Size="Small" Text="Tipo Afiliación:"></asp:Label></td>
                <td style="width: 416px; height: 16px">
                    <asp:Label ID="lblTipoAfiliacion" runat="server" Font-Bold="True" Font-Size="Small" CssClass="subHeader"></asp:Label></td>
            </tr>
            <tr>
                <td style="width: 106px; height: 16px">
                    <asp:Label ID="Label3" runat="server" Font-Size="Small" Text="Fecha Afiliación:" Width="94px"></asp:Label></td>
                <td style="width: 416px; height: 16px">
    ...
    <asp:Panel ID="pnlNucleo" runat="server" Visible="False" Width="543px">
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Small" EnableViewState="False" Height="20px" Width="256px" CssClass="subHeader">Composición del Núcleo Familiar</asp:Label><br />
    ...
    <table border="0" cellpadding="0" cellspacing="0">
        ...
        <br />
                    ...
                    1 – Si usted aparece afiliado en una ARS distinta a la de su elección, entonces deberá
        contactar a la DIDA al teléfono 809-472-1900 opción 6.
        <br />
                    <br />
        ...
        </strong></span>en la Tesorería de la Seguridad Social, en este caso deberá
        contactar a la DIDA para informar sobre su situación.<br />
                    <br />
                    3 – Si su núcleo familiar está incompleto, debe contactar directamente
        a su ARS para informarle de la situación de sus dependientes que no aparecen registrados.
                        <br />
                </span>
                </span>
            </td>
