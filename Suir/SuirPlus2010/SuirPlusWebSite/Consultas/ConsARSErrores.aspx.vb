Imports SuirPlus
Imports System.Data
Partial Class Consultas_ConsARSErrores
    Inherits BasePage
...
#End Region
    ...
    Private Sub BindErrores(ByVal IdCarga As Integer)
        Try
            ...
            dt = Ars.Consultas.getErroresDipersion(IdCarga)
    ...
    Private Sub BindDetallesErrores(ByVal IDError As Integer)
        ...
        Try
            Dim dt As New DataTable
            dt = Ars.Consultas.getDetalleErroresDispersion(IDError, pageNum, PageSize)
