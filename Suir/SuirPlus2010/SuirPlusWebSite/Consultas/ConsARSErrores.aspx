<%@ Page Language="VB" MasterPageFile="~/SuirPlus.master" AutoEventWireup="false" CodeFile="ConsARSErrores.aspx.vb" Inherits="Consultas_ConsARSErrores" title="Consulta de Errores de Dispersion" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
<asp:Label ID="lblTitulo" runat="server" CssClass="header">Consulta de Errores de Dispersión</asp:Label><br />
    ...
    <td>
     ...
     <asp:GridView ID="gvDetalleErrores" runat="server" AutoGenerateColumns="False" PageSize="15">
        <Columns>
            ...
            <asp:BoundField DataField="NSS_AFILIADO_PAGADO" HeaderText="NSS Afiliado Pagado" >
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="NSS_DISPARA_PAGO" HeaderText="NSS Dispara Pago" >
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="ID_REFERENCIA" HeaderText="ID Referencia" />
            <asp:BoundField DataField="NOMBRE_NACHA" HeaderText="Nombre Nacha" />
            <asp:BoundField DataField="FECHA_ENVIO_NACHA" HeaderText="Fecha Envio" DataFormatString="{0:d}" HtmlEncode="False" >
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="ID_ERROR" HeaderText="ID Error" >
                <ItemStyle HorizontalAlign="Center" />
