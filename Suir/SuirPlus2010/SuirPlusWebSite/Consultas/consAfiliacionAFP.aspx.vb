...
Partial Class Consultas_consAfiliacionAFP
    Inherits BasePage
    ...
    Protected Sub btBuscarRef_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btBuscarRef.Click
        ...
        Dim Resultado_Afiliacion As String = String.Empty
        ...
        Try
            ...
            Resultado_Afiliacion = SuirPlus.Empresas.Trabajador.TrabajadorActivoNominaEmpleador(UsrRegistroPatronal, txtnodocumento.Text)


            If Resultado_Afiliacion = "true" Then
    ...
    Private Sub limpiar()
        ...
        Response.Redirect("consAfiliacionAFP.aspx")
    End Sub
