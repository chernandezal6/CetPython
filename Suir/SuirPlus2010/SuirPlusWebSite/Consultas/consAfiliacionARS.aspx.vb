...
Partial Class Consultas_consAfiliacionARS
    Inherits BasePage
    ...
    Protected Sub btBuscarRef_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btBuscarRef.Click
        ...
        Dim Resultado_AfiliacionARS As String = String.Empty
        ...
        Try
            ...
            Resultado_AfiliacionARS = SuirPlus.Empresas.Trabajador.TrabajadorActivoNominaEmpleador(UsrRegistroPatronal, txtnodocumento.Text)

            If Resultado_AfiliacionARS = "true" Then
                ...
                If ds.Tables.Count > 0 Then
                    ...
                    If Not IsNothing(ds.Tables("AfiliacionSFS")) Then
                        ...
                        'Detalle
                        gvNucleoFamiliar.DataSource = ds.Tables("AfiliacionSFS")
                        gvNucleoFamiliar.DataBind()


                        pnlInfo.Visible = True
                        pnlNucleo.Visible = True
                        Me.lblError.Visible = False

                    Else

                        If Not IsNothing(ds.Tables("SolicitudSFS")) Then

                            'Encabezado
                            'Encabezado Solicitudes ARS
                            ...
                            'Detalle
                            gvNucleoFamiliar.DataSource = ds.Tables("SolicitudSFS")
                            gvNucleoFamiliar.DataBind()
            ...
            Else
                Me.lblError.Visible = True
                Me.lblError.Text = "El trabajador no está activo en la nómina perteneciente a este empleador."
    ...
    Private Sub limpiar()
        Response.Redirect("consAfiliacionARS.aspx")
    End Sub
