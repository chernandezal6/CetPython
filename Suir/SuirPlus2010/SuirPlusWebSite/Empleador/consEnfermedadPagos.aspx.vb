Imports SuirPlus
Imports System.Data
Partial Class Empleador_consEnfermedadPagos
    Inherits BasePage
...
#Region "Navegacion CuentaBancaria"
    ...
    Private Sub gvCBanco()
        Try
            Dim dtCBanco As DataTable = Empresas.SubsidiosSFS.Consultas.getPagoEnfCuentaBancaria(UsrRegistroPatronal, pageNum, PageSize, txtCedula.Text)
...
#Region "NP"
    ...
    Private Sub gvPagoN()
        Try
            Dim dtPagoN As DataTable = Empresas.SubsidiosSFS.Consultas.getPagoEnfNotificacionPago(UsrRegistroPatronal, pageNumNP, PageSizeNP, txtCedula.Text)
...
#Region "Error"
    ...
    Private Sub gvPagoErrores()
        Try
            Dim dtPagoErrores As DataTable = Empresas.SubsidiosSFS.Consultas.getPagoEnfError(UsrRegistroPatronal, pageNumE, PageSizeE, txtCedula.Text)
